<h2><a href="https://leetcode.com/problems/paint-house-iii/?envType=study-plan-v2&envId=dynamic-programming-grandmaster">1583. Paint House III</a></h2><h3>Hard</h3><hr><p>There is a row of <code>m</code> houses in a small city, each house must be painted with one of the <code>n</code> colors (labeled from <code>1</code> to <code>n</code>), some houses that have been painted last summer should not be painted again.</p>
