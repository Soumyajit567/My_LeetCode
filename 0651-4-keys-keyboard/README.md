<h2><a href="https://leetcode.com/problems/4-keys-keyboard/?envType=study-plan-v2&envId=dynamic-programming-grandmaster">651. 4 Keys Keyboard</a></h2><h3>Medium</h3><hr><p>Imagine you have a special keyboard with the following keys:</p>
